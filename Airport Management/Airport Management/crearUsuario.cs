...
namespace Airport_Management
{
    public partial class crearUsuario : Form
    {
        ...
        {
            if (txtApellido.Text.Length == 0 || txtContra.Text.Length == 0 || txtCorreo.Text.Length == 0 || txtNombre.Text.Length == 0 || txtTelefono.Text.Length == 0 || txtUsuario.Text.Length == 0)
            {
                MessageBox.Show("Todos los campos deben estar completos");
            }
            else if (gu.usuarioExiste(txtUsuario.Text)) 
